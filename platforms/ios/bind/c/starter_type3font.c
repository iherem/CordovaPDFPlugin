/* $Id: starter_type3font.c,v 1.7.2.1 2013/07/09 13:16:44 rp Exp $
 * Type 3 font starter:
...
#define BUFLEN 1024
    ...
    PDF_TRY(p) {
        ...
        /* glyph for .notdef */
        PDF_begin_glyph_ext(p, 0x0000, "width=266 boundingbox={0 0 0 0}");
        PDF_end_glyph(p);

        /* glyph for U+0020 space */
        PDF_begin_glyph_ext(p, 0x0020, "width=266 boundingbox={0 0 0 0}");
        PDF_end_glyph(p);

        /* glyph for U+006C "l" */
        PDF_begin_glyph_ext(p, 0x006C, "width=266 boundingbox={0 0 266 570}");
