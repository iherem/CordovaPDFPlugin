/* $Id: starter_basic.c,v 1.8.2.6 2014/05/08 13:17:40 rp Exp $
 *
 * Basic starter:
...
main(void)
{
    ...
    PDF_TRY(p) {
         ...
         */
        sprintf(optlist, "fontname={LinLibertine_R} encoding=unicode embedding "
        ...
        sprintf(optlist, "fontname={LinLibertine_R} encoding=unicode "
                  "embedding fontsize=24 textformat=utf8  charref=true");
        ...
        sprintf(optlist, "boxsize={400 400} position={center} fitmethod=meet");
