/* $Id: starter_textline.c,v 1.7.2.1 2013/07/09 13:16:44 rp Exp $
 * Starter text line:
...
main(void)
{
    ...
    PDF_TRY(p) {
        ...
        sprintf(optlist,
            "underline underlinewidth=7%% underlineposition=-20%%");
        ...
        sprintf(optlist, "horizscaling=150%%");
        ...
        sprintf(optlist, "charspacing=30%%");
        ...
        sprintf(optlist, "wordspacing=50%%");
        ...
        sprintf(optlist, "fillcolor={rgb 0.5 0.2 0.5}");
        ...
        sprintf(optlist, "boxsize={200 20} showborder");
        ...
        sprintf(optlist, "boxsize={200 20} position={top right} showborder");
         ...
         */
        sprintf(optlist, "boxsize={130 20} fitmethod=clip showborder");
         ...
         */
        sprintf(optlist, "boxsize={130 20} fitmethod=auto showborder");
         ...
         * the box.
         */
        sprintf(optlist, "boxsize={100 20} fitmethod=auto showborder");
