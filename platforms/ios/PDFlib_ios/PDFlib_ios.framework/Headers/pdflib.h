/*---------------------------------------------------------------------------*
 |          Copyright (c) 1997-2016 PDFlib GmbH. All rights reserved.        |
 +---------------------------------------------------------------------------+
...
/* $Id: pdflib.h,v 1.418.2.72.2.1 2016/12/15 13:10:43 rjs Exp $
 *
...
#define PDFLIB_MINORVERSION	1       	/* minor version number */
#define PDFLIB_REVISION		0       	/* revision number */
#define PDFLIB_SHORT_VERSIONSTRING "9"          /* short version number */
#define PDFLIB_LONG_VERSIONSTRING  "9.1.0" /* full version number*/
